...
describe("Index page when awdeorio is logged in with real database", () => {
  ...
  it("Loads the index page feed including links, images, and comment text", () => {
    loadFeed();
  });

  it("Shows a new comment without a page refresh", () => {
  ...
  it("Removes a comment from the UI after pressing the delete comment button", () => {
  ...
  it("Updates the UI when liking or unliking a post", () => {
...
describe("Index page when awdeorio is logged in with mock database", () => {
  ...
  it("Updates the feed when refreshing after a new post is created", () => {
    // Go to the home page.
    cy.visit("/");
